package com.example.intermediateattestat.controllers;

import com.example.intermediateattestat.enumm.Status;
import com.example.intermediateattestat.models.Cart;
import com.example.intermediateattestat.models.Order;
import com.example.intermediateattestat.models.Person;
import com.example.intermediateattestat.models.Product;
import com.example.intermediateattestat.repositories.CartRepository;
import com.example.intermediateattestat.repositories.OrderRepository;
import com.example.intermediateattestat.repositories.ProductRepository;
import com.example.intermediateattestat.security.PersonDetails;
import com.example.intermediateattestat.services.PersonService;
import com.example.intermediateattestat.services.ProductService;
import com.example.intermediateattestat.util.PersonValidator;
...
public class MainController {
    ...
    public String index(Model model){
        ...
        if(role.equals("ROLE_ADMIN")){
            //role = "ROLE_ADMIN";
            //personDetails.getPerson().setRole(role);
            ...
            if(!price.isEmpty()){
                if(price.equals("sorted_by_ascending_price")) {
                    if (!contract.isEmpty()) {
                        ...
                        } else if (contract.equals("imageAI")) {
                        ...
                        } else if (contract.equals("streamAI")) {
